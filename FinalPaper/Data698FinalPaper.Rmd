...
- Out of all the strategies under investigation, which strategy gives us the best odds of winning (if any)?

- What correlations exist between winning numbers and payout amounts?
...
```{r code=readLines(knitr::purl('../Data698AppendixCode.Rmd', documentation = 0)), eval = FALSE}
```

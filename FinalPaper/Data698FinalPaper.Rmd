...
In the T-test results above, the **_p_** value of _0.05222_ indicates that the average winnings of the Most Frequent Numbers strategy are close to significantly different to those of the base case. Nevertheless, it is still above 0.05 which would suggest that we cannot reject the null hypothesis that neither strategy is more effective than the other.

However, the hign **_t_** value of _1.9415_.    

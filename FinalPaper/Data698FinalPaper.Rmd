...
For the Least Frequent Numbers strategy, we generated a lottery ticket using the least frequent winning numbers extracted from the Mega Millions Winning Numbers dataset and played the same ticket against a randomly generated winning ticket for each trail.
...
### Frequency of Mega Ball and Winning Numbers Analysis 
...
In order to simulate both of these approaches, we first needed to find the numbers that conformed to each philosophy. To do this, we ran through the historical Mega Millions winning numbers dataset and counted the frequency of both the most and least frequently occurring winning Mega Ball and base numbers.We then ranked each number in accordance to it's frequency.

This provided us with a set of the top _n_ most/least frequently occurring numbers from which to create tickets for use in our Hot Hand and Gambler's Fallacy (_Most and Least Frequent Numbers strategies_) based simulations. This process left us with the following Mega Ball and base number pools from which to pull from:


\centering

#### Most Frequently Occurring Numbers Set
...
##### Least Frequently Occurring Numbers Set

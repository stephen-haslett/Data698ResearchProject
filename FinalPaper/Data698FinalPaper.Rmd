...
Null Hypothesis: No one strategy is more effective than the other.

Alternative Hypothesis: Strategies are not equal in terms of their effectiveness.

### Consistent Numbers Strategy (_Base Case_)
...
In the T-test results above, the high **_p_** value of _0.8872_ indicates that the average winnings of the Most Frequent Numbers strategy are not significantly different to those of the base case, and therefore we cannot reject the null hypothesis that neither strategy is more effective than the other. This observation is further consolidated by the low **_t_** value of _0.14182_.     

...
(_From the nylottery and megamillions websites_), we will identify data trends and use simulations to answer the aforementioned questions. In addition to testing various "winning strategies",
we also want to explore lottery payout amounts, as jackpot numbers change, and prize money expections.

...
# In order to acheive consistent results in our training data, we manually split the dataset into training and test sets (70/30 split). Using a training/test
# split function such as "initial_split()"" results in inconsistent results everytime the program is run.

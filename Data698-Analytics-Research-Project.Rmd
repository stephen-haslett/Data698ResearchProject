...
```{r, selectFrequentlyOccurringWinningNumbers}
...
#'
#' @param lotteryNumbersToPlay Dataframe: The dataframe column in which to count all indivdual number occurrences.
#' Must be in the format "dataframe$columnname".
#'
#' @param winningNumbersTestSet Dataframe: A test dataset of winning numbers to play against.
#'
#' @return Dataframe: A dataframe of all the numbers within the given column and the number of times each
#' number occurs (ordered by number of occurrences).
#'
#' @export
simulateLotteryGame <- function(lotteryNumbersToPlay, winningNumbersTestSet) {

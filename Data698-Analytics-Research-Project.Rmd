...
#'
#' @export
lotteryGameSimulation <- function(lotteryNumbersToPlay, testData, includeMegaBall = FALSE) {
  # If the Mega Ball should be include in the winning numbers, subset the data into
  # winning_numbers an mega_ball columns. Otherwise, just include the winning_numbers column.
  if (isTRUE(includeMegaBall)) {
    winningNumbers <- subset(testData, select = c(winning_numbers, mega_ball))
  }
  else {
    winningNumbers <- subset(testData, select = c(winning_numbers))
  }
...
test <- lotteryGameSimulation(randomNumbers$winning_numbers, testData)

...
```{r megaBallMatch}
#' Checks if a simulated lottery ticket Mega Ball value matches the Mega Ball value in the winning numbers test dataset.
#'
#' @param ticketMegaBall Numeric: The "Mega Ball" value contained within a simulated ticket.
#'
#' @param winningMegaBall Numeric: The "Mega Ball" value contained within the winning lottery numbers test dataset.
#'
...
kable(consistentResults, "html", escape = F) %>% kable_styling("striped", full_width = T) %>% column_spec(1, bold = T)
```

...
```{r, generateFrequencyBasedLotteryTickets}
...
#'
#' @export
generateFrequencyBasedLotteryTickets <- function(trainingDataColumn, columnName) {
  countTotalNumberOfOccurrencesByColumn(trainingDataColumn, columnName)
}
```
...
gameSimulation <- function(ticketNumbers, testData, generationMethod) {
  ...
  if (generationMethod == 'frequency') {
    lotteryNumbers <- generateFrequencyBasedLotteryTickets(ticketNumbers, rowCount)
  }

...
# Add totals to a results summary dataframe.
randomResultsSummary <- data.frame(total_winning_numbers_matched, total_mega_ball_matches, total_multiplier_matches, total_winnings)

# Output results summary as a table.
rownames(randomResultsSummary) <- c()
columnNames <- c('Total Winning Numbers Matched', 'Total Mega Ball Matches', 'Total Multiplier Number Matches', 'Total Winnings')
kable(randomResultsSummary, 'html', table.attr = "class=\'random-totals-table\'", escape = F,
      caption = '<center><h3>Random Numbers Strategy Totals</h3></center>', col.names = columnNames) %>%
  column_spec(1:4, bold = T) %>%
  kable_styling('striped') %>%
  scroll_box(width = '100%', height = 'auto')
...
# Add totals to a results summary dataframe.
frequentResultsSummary <- data.frame(total_winning_numbers_matched, total_mega_ball_matches, total_multiplier_matches, total_winnings)

# Output results summary as a table.
rownames(frequentResultsSummary) <- c()
columnNames <- c('Total Winning Numbers Matched', 'Total Mega Ball Matches', 'Total Multiplier Number Matches', 'Total Winnings')
kable(frequentResultsSummary, 'html', table.attr = "class=\'frequent-totals-table\'", escape = F,
      caption = '<center><h3>Most Frequent Numbers Strategy Totals</h3></center>', col.names = columnNames) %>%
  column_spec(1:4, bold = T) %>%
  kable_styling('striped') %>%
  scroll_box(width = '100%', height = 'auto')
...
consistentResultsSummary <- data.frame(consistent_strategy, total_consistent_winning_numbers_matched, total_consistent_mega_ball_matches,
                                       total_consistent_multiplier_matches, total_consistent_winnings)
colnames(consistentResultsSummary) <- c('Strategy', 'Total Winning Numbers Matched', 'Total Mega Ball Matches', 'Total Multiplier Number Matches', 'Total Winnings')
...
randomResultsSummary <- data.frame(random_strategy, total_random_winning_numbers_matched, total_random_mega_ball_matches,
                                   total_random_multiplier_matches, total_random_winnings)
colnames(randomResultsSummary) <- c('Strategy', 'Total Winning Numbers Matched', 'Total Mega Ball Matches', 'Total Multiplier Number Matches', 'Total Winnings')
...
frequentResultsSummary <- data.frame(frequent_strategy, total_frequent_winning_numbers_matched, total_frequent_mega_ball_matches,
                                     total_frequent_multiplier_matches, total_frequent_winnings)

colnames(frequentResultsSummary) <- c('Strategy', 'Total Winning Numbers Matched', 'Total Mega Ball Matches', 'Total Multiplier Number Matches', 'Total Winnings')
...
columnNames <- c('Strategy', 'Total Winning Numbers Matched', 'Total Mega Ball Matches', 'Total Multiplier Number Matches', 'Total Winnings')
kable(strategyResultsComparison %>% arrange(desc(`Total Winning Numbers Matched`)), 'html', table.attr = "class=\'strategy-results-comparision-table\'", escape = F,
